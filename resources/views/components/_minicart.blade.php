...
<div class="mini-cart-wrap">
    ...
    <ul class="mini-cart-products">
        <li>
            <a class="image"><img src="{{ asset('images/product/product-1.png') }}" alt="Product"></a>
            <div class="content">
        ...
        <li>
            <a class="image"><img src="{{ asset('images/product/product-2.png') }}" alt="Product"></a>
            <div class="content">
        ...
        <li>
            <a class="image"><img src="{{ asset('images/product/product-3.png') }}" alt="Product"></a>
            <div class="content">
