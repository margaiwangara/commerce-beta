                    ...
                    <div class="cart-table table-responsive mb-40">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="pro-thumbnail"><a href="#"><img src="{{ asset('images/product/product-2.png') }}" alt="Product"></a></td>
                                ...
                                <tr>
                                    <td class="pro-thumbnail"><a href="#"><img src="{{ asset('images/product/product-3.png') }}" alt="Product"></a></td>
                                ...
                                <tr>
                                    <td class="pro-thumbnail"><a href="#"><img src="{{ asset('images/product/product-4.png') }}" alt="Product"></a></td>
...
<div class="banner-section section mb-90">
    <div class="container">
        <div class="row">
            ...
            {{-- Banner --}}
            <div class="col-12">
                <div class="banner"><a href="#"><img src="{{ asset('images/banner/banner-10.jpg') }}" alt="Banner"></a></div>
            </div>
